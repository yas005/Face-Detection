...
parser.add_argument('--pred_path', help="path for predicted annotation", default="yolox_x_pred")
parser.add_argument('--gt_path', help="path for gt annotation", default="test_annotations_txt")
...
GT_PATH = os.path.join(os.getcwd(), 'input', args.gt_path)
DR_PATH = os.path.join(os.getcwd(), 'input', args.pred_path)
# if there are no images then no animation can be shown
IMG_PATH = os.path.join(os.getcwd(), 'input', 'test_image')
